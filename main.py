...
def main():
    ...
    if model_name_user == 'MC':
        ...
        mean_forecast, lower_limits, upper_limits, mu, phi, theta, resid_arima, p_input, q_input=utils.arma_garch_model(data=df,n=n,sim=10000,day_type=day_type_user,mark_type=mark_type_user,arma_or_not=True, optimizer=True, combined=False, vol_type=str('GARCH'), dist_type='normal', mean_type='constant', o_type=0, arma_resid=False)
        ...
        difference, min_values_ar_garch, max_values_ar_garch, sigma_t, epsilon_t, alpha_params, beta_params, alpha_temp, beta_temp, omega, mu_garch, pred, nu= utils.arma_garch_model(data=df.dropna(),n=n,sim=10000,day_type=day_type_user,mark_type=mark_type_user,arma_or_not=False, optimizer=False, combined=False, vol_type='GARCH', dist_type='normal', mean_type='constant', o_type=0, arma_resid=False)
