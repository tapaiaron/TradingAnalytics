...
def main():
    ...
    if model_name_user == 'MC':
        ...
        mean_forecast, lower_limits, upper_limits=utils.arma_garch_model(data=df,n=n,sim=10000,day_type=day_type_user,mark_type=mark_type_user,arma_or_not=True, optimizer=False, combined=False, vol_type='GARCH', dist_type='normal', mean_type='constant', o_type=0, arma_resid=False)
